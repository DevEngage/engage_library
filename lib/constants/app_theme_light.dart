...
class AppThemes {
  ...
  static final TextTheme _lightTextTheme = TextTheme(
    headline1: TextStyle(
        fontSize: 20.0, color: Color(0xFF1F2D3D), fontWeight: FontWeight.w600),
    headline2: TextStyle(fontSize: 12.0, color: Color(0xFF6E84A3)),
    headline3: TextStyle(fontSize: 26.0, color: Color(0xFF12263F)),
    bodyText1: TextStyle(fontSize: 14.0, color: _lightTextColor),
  ...
  static ThemeData get lightTheme => ThemeData(
        ...
        dataTableTheme: DataTableThemeData(
          dataTextStyle: TextStyle(fontSize: 10, color: Color(0xFF1F2D3D)),
          headingRowColor: MaterialStateProperty.all(Color(0xFFF9FAFC)),
        ...
        bottomAppBarColor: Color(0xFF6E84A3),
        cardTheme: CardTheme(
          shape: RoundedRectangleBorder(
            side: BorderSide(color: AppThemes.cardOutline, width: 1),
